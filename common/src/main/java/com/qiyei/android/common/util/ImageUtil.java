...
//    }
    ...
    public static Bitmap scaleImage(Bitmap origin,int reqWidth,int reqHeight){
        ...
        Log.d(TAG,"scaleImage originWidth:" + width + ",originHeight:" + height);

        float scaleWidth = (float) (reqWidth * 1.0 / width);
        float scaleHeight = (float) (reqHeight * 1.0 / height);
        Log.d(TAG,"scaleImage scaleWidth:" + scaleWidth + ",scaleHeight:" + scaleHeight);
        ...
        Log.d(TAG,"scaleImage newWidth:" + newBitmap.getWidth() + ",newHeight:" + newBitmap.getHeight());
        return newBitmap;
    }
    ...
    public static Bitmap scaleImage(Bitmap origin,float ratio){
        ...
        Log.d(TAG,"scaleImage ratio:" + ratio);
    ...
    public static Bitmap cropImage(Bitmap origin,int reqWidth,int reqHeight,int direction){
        ...
        int width = origin.getWidth();
        int height = origin.getHeight();
        Log.d(TAG,"cropImage originWidth:" + width + ",originHeight:" + height);

        if (!(reqWidth < width) || !(reqHeight < height)){
            Log.e(TAG," reqWidth or reqHeight cannot be more than origin !");
            return null;
        }
        ...
        switch (direction){
            ...
            case CENTER:
                ...
                break;
            default:
                Log.e(TAG," please check or direction,it must be correct params !");
                return null;
        }
        ...
        Log.d(TAG,"cropImage nnewWidth:" + newBitmap.getWidth() + ",newHeight:" + newBitmap.getHeight());
        return newBitmap;
    }
    ...
    public static Bitmap rotateBitmap(Bitmap origin,float degress){
        ...
        Log.d(TAG,"rotateBitmap originWidth:" + width + ",originHeight:" + height);

        Log.d(TAG,"rotateBitmap degress:" + degress);
        ...
        Log.d(TAG,"rotateBitmap newWidth:" + newBitmap.getWidth() + ",newHeight:" + newBitmap.getHeight());
        return newBitmap;
    }
    ...
    public static Bitmap skewBitmap(Bitmap origin,float kx,float ky){
        ...
        Log.d(TAG,"skewBitmap originWidth:" + width + ",originHeight:" + height);

        Log.d(TAG,"skewBitmap kx:" + kx + ",ky:" + ky);
        ...
        Log.d(TAG,"skewBitmap newWidth:" + newBitmap.getWidth() + ",newHeight:" + newBitmap.getHeight());
        return newBitmap;
    }
